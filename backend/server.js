...
const allowedOrigins = [process.env.FRONTEND_URL, 'https://startup-crm-lite-rho.vercel.app', 'https://startup-crm-lite-production-af79.up.railway.app', 'http://localhost:5174', 'http://localhost:5173'];
app.use(cors({
