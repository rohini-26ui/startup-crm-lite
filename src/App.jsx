...
function App() {
  ...
  return (
    ...
    <Router>
      ...
      {/* Main container: column on mobile for bottom nav, row on tablet+ for sidebar */}
      <div className="flex flex-col md:flex-row h-screen bg-gray-50 dark:bg-gray-900 overflow-hidden transition-colors duration-200">
        ...
        <main className="flex-1 overflow-y-auto p-4 pb-24 md:p-6 md:pb-6 transition-colors duration-200">
